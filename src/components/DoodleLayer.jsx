...
const LineGraph = () => (
  <svg width="140" height="100" viewBox="0 0 140 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-20">
    <path 
...
const BarChart = () => (
  <svg width="120" height="100" viewBox="0 0 120 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-20">
...
const Nodes = () => (
  <svg width="140" height="80" viewBox="0 0 140 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-20">
...
const Lasso = () => (
  <svg width="100" height="60" viewBox="0 0 100 60" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-20">
...
export default function DoodleLayer() {
  return (
    <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden select-none">
      {/* Top Left Area */}
      <div className="absolute top-[15%] left-[5%] animate-float-slow text-[var(--color-cyan)] -rotate-6">
        <LineGraph />
      </div>
      <div className="absolute top-[35%] left-[3%] animate-float-medium text-[var(--color-purple)] rotate-12">
        <Spark />
      </div>

      {/* Top Right Area */}
      <div className="absolute top-[12%] right-[8%] animate-float-medium text-[var(--color-text-3)] rotate-12">
        <BarChart />
      </div>
      <div className="absolute top-[28%] right-[4%] animate-float-slow text-[var(--color-cyan)] -rotate-12">
        <Search />
      </div>

      {/* Bottom Left Area */}
      <div className="absolute bottom-[20%] left-[8%] animate-float-medium text-[var(--color-text-3)] -rotate-12">
        <Nodes />
      </div>
      <div className="absolute bottom-[35%] left-[25%] animate-float-slow text-[var(--color-purple)] rotate-45">
        <Checkmark />
      </div>

      {/* Bottom Right Area */}
      <div className="absolute bottom-[15%] right-[10%] animate-float-slow text-[var(--color-text-3)] rotate-45">
        <Lasso />
      </div>
      <div className="absolute bottom-[40%] right-[15%] animate-float-medium text-[var(--color-cyan)] -rotate-12">
        <Spark />
      </div>

      {/* Center Top */}
      <div className="absolute top-[8%] left-[50%] -translate-x-1/2 animate-float-slow text-[var(--color-text-2)] opacity-20">
        <Checkmark />
      </div>
    </div>
  )
